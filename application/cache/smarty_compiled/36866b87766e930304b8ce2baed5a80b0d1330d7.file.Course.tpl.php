<?php /* Smarty version Smarty-3.1.18, created on 2016-05-24 02:41:35
         compiled from "C:\Users\WLB\Desktop\sim\application\views\Course.tpl" */ ?>
<?php /*%%SmartyHeaderCode:31716573adde8371eb1-50395297%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '36866b87766e930304b8ce2baed5a80b0d1330d7' => 
    array (
      0 => 'C:\\Users\\WLB\\Desktop\\sim\\application\\views\\Course.tpl',
      1 => 1464075692,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31716573adde8371eb1-50395297',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_573adde861bfc2_48085250',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_573adde861bfc2_48085250')) {function content_573adde861bfc2_48085250($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>login</title>
...
<div class="text-center form-group ">
    <div class="pull-left" >
        <h1 class="text-center text-primary">学院</h1>
        <select id="college" class="form-control input-lg" onchange="course_option()">
        </select>
    </div>
    <div class="pull-left">
        <h1 class="text-center text-primary">课程</h1>
        <select id="course" class="form-control input-lg">
        </select>
    </div>
    <div class="pull-left">
        <h1 class="text-center text-primary">起始周</h1>
    ...
    <div class="pull-left">
        <h1 class="text-center text-primary">结束周</h1>
        <select id="endW" class="form-control input-lg" >
            <option value="1">第一周</option>
            <option value="2">第二周</option>
            <option value="3">第三周</option>
            <option value="4">第四周</option>
    ...
    <div class="pull-left ">
        <h1 class="text-center text-primary" onclick="classroom_option()">查找教室</h1>
        <select id="classroom" class="form-control input-lg" >
        </select>
    </div>
    <div class="pull-left">
        <h1 class="text-center text-primary">确定排课</h1>
